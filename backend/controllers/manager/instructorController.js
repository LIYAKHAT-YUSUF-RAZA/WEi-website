...
const createInstructor = asyncHandler(async (req, res) => {
  const { name, email, phone, bio, image, experience, rating, specialization, socialLinks } = req.body;
...
const updateInstructor = asyncHandler(async (req, res) => {
  const { name, email, phone, bio, image, experience, rating, specialization, socialLinks, status } = req.body;
